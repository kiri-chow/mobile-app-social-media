            ...
            <ion-col class="ion-align-items-center">
                <ion-row class="ion-text-start ion-justify-content-center ion-align-items-end">
                    ...
                    <ion-col class="ion-text-start">
                        <ion-icon class="profile-control" role="button" :color="editing? 'danger' : 'success'" :icon="createOutline" @click="editing = !editing "></ion-icon>
                    </ion-col>
                    <ion-col class="ion-text-end">
                        <ion-icon id="logout" class="profile-control" role="button" color="danger" :icon="exitOutline"></ion-icon>
                        <ion-alert trigger="logout" header="Log out" message="Do you want to log out?" :buttons="logoutButtons"/>
                    </ion-col>
                </ion-row>
...
<script setup>
import { IonText, IonIcon, IonGrid, IonRow, IonCol } from "@ionic/vue";
